...
const paginationStyles = {
    ...
    rounded: {
        none: '[ W>.rc-pagination-item]:rounded-none [&>.rc-pagination-options>.rc-pagination-options-quick-jumper>input]:rounded-none',
    ...
    variant: {
        solid: {
            ...
            color: {
                ...
                danger: '[&>.rc-pagination-item-active]:bg-red [&>.rc-pagination-item-active>a]:!text-white [&>li.rc-pagination-item-active]:border-red [&>.rc-pagination-item-active]:hover:border-red [&>.rc-pagination-item-active]:focus:border-red',
            },
        },
        flat: {
            base: '',
...
export default function Pagination({
    ...
    return (
        <RcPagination
            ...
            nextIcon={<NextIcon icon={nextIcon} rounded={rounded} outline={outline} className={nextIconClassName} />}
            prevIcon={<PrevIcon icon={prevIcon} rounded={rounded} outline={outline} className={prevIconClassName} />}
            jumpPrevIcon={
                <JumpPrevIcon
                    icon={jumpPrevIcon}
                    rounded={rounded}
